################################################################
###MISCELLANEA SCRIPT - DESCRIPTIVE STATISTICS RESTRICTED SET###
################################################################
...
This is a miscellanea script: a script to get the ranges of 
the continous variables in the Restrcited Set.
'''
...
#and now we stack them all together, again vertically.
...
#Summary statistics can easily be computed here.
